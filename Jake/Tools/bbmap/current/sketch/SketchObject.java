...
public class SketchObject {
	...
	public static boolean parseSketchFlags(String arg, String a, String b){
		...
		if(parseCoding(arg, a, b)){
			...
			preferSSUMapForEuks=Tools.parseBoolean(b);
			...
			useSSUMapOnlyForEuks=Tools.parseBoolean(b);
...
//		return Tools.max(hash64shift(kmer0), hash64shift(kmer0&0xFFFFFFFFFFFFL));//Something like this would be around 10% faster; not worth it.
