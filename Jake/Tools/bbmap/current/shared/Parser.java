...
public class Parser {
	...
	public boolean parseCardinality(String arg, String a, String b){
		if(a.equals("cardinality") || a.equals("loglog")){
			...
			loglogbuckets=Tools.parseIntKMG(b);
			...
			CardinalityTracker.trackCounts=Tools.parseBoolean(b);
		}else{
			return false;
		}
...
//			Read.VALIDATE_BRANCHLESS=Tools.parseBoolean(b);
			...
			Shared.setThreads(b);
			if(!silent){System.err.println("Set threads to "+Shared.threads());}
			...
			TaxTree.UNITE_MODE=Tools.parseBoolean(b);
...
//				ReadStats.ENTROPY_BINS_AUTO=false;
	...
	public static boolean parseSam(String arg, String a, String b){
		if(a.equals("samversion") || a.equals("samv") || a.equals("sam")){
			...
			SamLine.FLIP_ON_LOAD=Tools.parseBoolean(b);
