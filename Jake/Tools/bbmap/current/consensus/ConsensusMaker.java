	...
	private Parser parse(String[] args){
		...
		for(int i=0; i<args.length; i++){
			...
			if(a.equals("verbose")){
				...
				printScores=Tools.parseBoolean(b);
			}else if(a.equalsIgnoreCase("useMapq")){
				useMapq=Tools.parseBoolean(b);
